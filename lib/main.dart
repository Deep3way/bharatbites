  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: isSwitched
        ...
        appBarTheme: const AppBarTheme(backgroundColor: Color(0xFFFFFF99),foregroundColor: Colors.black)
        ...
        drawer: Drawer(
          child: ListView(
            ...
            children: <Widget>[
              ...
              const ListTile(title: Text("Made with ❤️ in india by Rudradeep")),
            ],
          ),
        ),
        appBar: AppBar(
          centerTitle: true,
          title: const Text('BharatBites'),
          actions: [
            Transform.scale(
              scale: 0.4,
